...
Prendi queste tre inserzioni ad esempio:
      ...
      job3:  location: "US"          position: "dev"

Cercando contemporaneamente come posizione lavorativa "dev" e posizione geografica "US", dovresti ottenere come risultato solamente job1 e job3,
in quanto job2 non soddisfa la condizione posta sulla posizione geografica.

! REQUISITI:
TODO - il tuo algoritmo deve tornare i risultati nella seguente forma:
{
  result: [], <-- inserisci qui le inserzioni che rispecchiano la posizione lavorativa e la posizione geografica richiesta
  count: 0 <-- inserisci qui il numero totale delle inserzioni trovate
}

TODO - da ogni inserzione trovata, elimina i campi "description", "requirements", "benefits" e "company_profile" per semplificare il risultato

TODO - la tua ricerca deve essere "case insensitive" (non deve essere influenzata da lettere maiuscole o minuscole nelle parole cercate)
*/
...
let result = [];
let titleKeyword = "DeVeLoPer";
let locationKeyword = "Us";
...
console.log(result);
console.log(`${result.length} results have been found from your research`);
